    ...
    $.fn.asHTML5VideoControls = function(skinFolder, parentInst, videoElem, hideControls, hidePlayButton, defaultVolume, fullscreenNativeControls, html5VideoNoDownload, skinImages) {
        ...
        if ($videoFSObj.get(0).requestFullscreen || $videoFSObj.get(0).webkitRequestFullScreen || $videoFSObj.get(0).mozRequestFullScreen || $videoFSObj.get(0).webkitEnterFullScreen || $videoFSObj.get(0).msRequestFullscreen) {
            ...
            var switchScreenCSS = function(fullscreen) {
                ...
                else if (fullscreen) { $(document).on("mousemove", userActivate);
                    $videoControls.css({ "z-index": 2147483647, position: "fixed" });
                    $videoFullscreenBg.css({ "z-index": 2147483647, display: "block" });
                    $videoPlay.css({ "z-index": 2147483647 }) } else { $(document).off("mousemove", userActivate);
            ...
            $videoFSObj.get(0).addEventListener("webkitbeginfullscreen",
                function() { isFullscreen = true;
                    switchScreenCSS(isFullscreen) }, false);
            $videoFSObj.get(0).addEventListener("webkitendfullscreen", function() { isFullscreen = false;
                switchScreenCSS(isFullscreen) }, false);
        ...
        if ($videoObj.get(0).volume ===
            ...
            $videoVolumeButton.css({
                ...
                $(this).css({ "background-position": backgroundPosX + " bottom" }) }, function() { var backgroundPosX = $(this).css("background-position") ? $(this).css("background-position").split(" ")[0] : $(this).css("background-position-x");
                $(this).css({ "background-position": backgroundPosX + " top" }) }).on(eClick,
                function() {
                    var volume = $videoObj.get(0).volume;
        ...
        var onVideoUpdate = function() {
            ...
            if (curTime) {
                ...
                if (duration) {
                    ...
                    if (!sliderDragging) { var sliderW = $videoSeeker.width(); var pos = Math.round(sliderW * curTime / duration);
                        $videoSeekerPlay.css({ width: pos });
...
(function($) {
    $.fn.ashtml5lightbox = function(options) {
        ...
        if (inst.options.isChrome) { var match = navigator.userAgent.match(/Chrome\/([0-9]+)/);
        ...
        inst.supportKeyboard = function() {
            ...
            $(document).keyup(function(e) { if (!inst.showing) return; if (!inst.disableesckeyinfullscreen && inst.options.supportesckey && e.keyCode == 27) inst.finish();
        ...
        inst.checkParentClass = function(node, parentNode, attr) {
            ...
            $.each([node, parentNode], function(index,
                nodeValue) { if (nodeValue && nodeValue.attr("class")) { var classList = nodeValue.attr("class").split(/\s+/);
        ...
        inst.readNodeData = function(node, parentNode) {
            ...
            for (var i = 0; i < inst.elemArray.length; i++)
                if (node.attr("href") == inst.elemArray[i][ELEM_HREF]) { inst.elemArray[i][ELEM_TITLE] = title;
        ...
        inst.readData = function() { inst.each(function() { var self = $(this); if (this.nodeName.toLowerCase() == "a" || this.nodeName.toLowerCase() == "area") inst.readNodeData(self);
        ...
        inst.createMarkup = function() {
            ...
            if (inst.options.fullscreenmode) {
                ...
                if (inst.options.fullscreentextoutside) { inst.options.titlestyle = "outside";
                    inst.options.titlecss = inst.options.titleoutsidecss;
                    inst.options.descriptioncss = inst.options.descriptionoutsidecss } else if (inst.options.fullscreentextinside) { inst.options.titlestyle = "inside";
                    inst.options.titlecss = inst.options.titleinsidecss;
                    inst.options.descriptioncss = inst.options.descriptioninsidecss } else { inst.options.titlebottomcss = inst.options.fullscreentitlebottomcss;
        ...
        inst.html2Text = function(html) { var tag = document.createElement("div");
            tag.innerHTML = html; return tag.innerText };
        inst.slideTimer = function(interval, callback, updatecallback) {
            ...
            this.resume = function(forceresume) { if (startedandpaused && !forceresume) return;
                startedandpaused = false; if (started && paused) { paused = false;
            ...
            this.stop = function() { clearInterval(updateTimerId); if (updatecallback) updatecallback(-1);
                ...
                paused = false;
                started = false };
            this.start = function() { runningTime = 0;
                paused = false;
                started = true;
                updateTimerId = setInterval(function() { runningTime += updateinterval; if (runningTime > timerInstance.timeout) { clearInterval(updateTimerId); if (callback) callback() } if (updatecallback) updatecallback(runningTime / timerInstance.timeout) }, updateinterval) };
        ...
        inst.initSlide = function() { inst.autosliding = false;
        ...
        inst.loadElem = function(elem) {
            ...
            if ((inst.options.transition == "slide" || inst.options.transition == "crossfade") && inst.existingElem >= 0) {
                ...
                if (inst.options.titlestyle != "outside") { inst.$elemData = $(".html5-elem-data-box", inst.$elem);
        ...
        inst.showTitle =
            function(t, description) {
                ...
                if (inst.options.inGroup && inst.options.showplaybutton) {
                    ...
                    } else { $(".html5-play", inst.$lightbox).show();
        ...
        inst.showYoutubeVimeo = function(elem) {
            ...
            } else inst.resizeLightbox(dataW, dataH, true, function() { inst.showYouTubeVimeoCallback(elem, sizeObj);
                inst.showData() })
        };
        inst.showYouTubeVimeoCallback = function(elem, sizeObj) {
            ...
            if (elem[ELEM_TYPE] == 3) {
                ...
                href += "api=1&player_id=html5boxiframevideo" + inst.options.curElem; if (inst.options.mutevideo) href += "&muted=1" }
            ...
            inst.$elem.show();
            if (elem[ELEM_TYPE] == 3) { if (inst.options.inityoutube) { inst.youtubeFinishCount = 0;
                    inst.initYoutubeFinishCallback() } } else if (elem[ELEM_TYPE] == 4)
                if (inst.options.initvimeo) { inst.vimeoFinishCount = 0;
                    inst.initVimeoFinishCallback() }
        };
        inst.initYoutubeFinishCallback = function() {
            if (typeof YT === "object" && typeof YT.Player === "function") inst.ytplayer = new YT.Player("html5boxiframevideo" + inst.options.curElem, { events: { "onStateChange": function(event) { if (event.data == YT.PlayerState.ENDED) { $(window).trigger("html5lightbox.videofinished"); if (inst.autosliding) inst.gotoSlide(-1);
                            else if (inst.options.autoclose) setTimeout(function() { inst.finish() }, inst.options.autoclosedelay) } } } });
            else setTimeout(function() { if (inst.youtubeFinishCount < 10) { inst.youtubeFinishCount++;
                    inst.initYoutubeFinishCallback() } }, 300)
        };
        inst.initVimeoFinishCallback = function() {
            ...
            } else setTimeout(function() { if (inst.vimeoFinishCount < 10) { inst.vimeoFinishCount++;
                    inst.initVimeoFinishCallback() } }, 300)
        };
        inst.showPDF = function(elem) {
            if (inst.options.enablepdfjs) {
                if (inst.options.isIPhone &&
                    inst.options.openpdfinnewtaboniphone || inst.options.isIPad && inst.options.openpdfinnewtabonipad) { var win = window.open(elem[ELEM_HREF], "_blank");
                    win.focus();
                    inst.finish(); return }
            ...
            } else if (inst.options.isIPhone || inst.options.isIPad || inst.options.isAndroid || inst.options.isIE || inst.options.isIE11) { var win = window.open(elem[ELEM_HREF], "_blank");
                win.focus();
        ...
        inst.showWeb = function(elem) {
            ...
            inst.resizeLightbox(dataW, dataH, true, function() {
                ...
                inst.$elem.show();
                inst.showData();
                if (inst.options.autoresizecontent && inst.isSameDomain(elem[ELEM_HREF])) { $(".html5lightbox-web-iframe", inst.$image).data("sameorigin", true);
        ...
        inst.resizeWindow = function() {
            ...
            if (inst.currentElem[ELEM_TYPE] ==
                5 || inst.currentElem[ELEM_TYPE] == 7 || inst.currentElem[ELEM_TYPE] == 10) { var navH = inst.options.shownavigation && inst.navvisible ? inst.options.navheight : 0;
            ...
            if (inst.options.autoresizecontent && (inst.currentElem[ELEM_TYPE] == 5 || inst.currentElem[ELEM_TYPE] == 7 || inst.currentElem[ELEM_TYPE] == 10)) {
                ...
                if (inst.currentElem[ELEM_TYPE] ==
                    7 && $(".html5lightbox-web-iframe", inst.$lightbox).length > 0 && $(".html5lightbox-web-iframe", inst.$lightbox).data("sameoriginloaded")) { var iframe = $(".html5lightbox-web-iframe", inst.$lightbox)[0]; if (iframe && iframe.contentWindow && iframe.contentWindow.document && iframe.contentWindow.document.documentElement.offsetHeight)
                        if (elemH > iframe.contentWindow.document.documentElement.offsetHeight) { elemH = iframe.contentWindow.document.documentElement.offsetHeight;
                            resizeHeight = true } } else if (inst.currentElem[ELEM_TYPE] ==
                    10 && $(".html5lightbox-div", inst.$lightbox).length > 0) { var divH = $(".html5lightbox-div", inst.$lightbox).height(); if (elemH > divH) { elemH = divH;
                        resizeHeight = true } }
            ...
            if (inst.options.totalwidth <=
                winWidth) { $navMask.css({ width: inst.options.totalwidth + "px" });
                $navPrev.hide();
        ...
        inst.calcElemSize = function(sizeObj, keepratio) {
            ...
            if (inst.currentElem[ELEM_TYPE] == 0 && keepratio) {
                ...
                if (sizeObj.h > h0) { sizeObj.w = Math.round(ratio * h0);
                    sizeObj.h = h0 }
                if (sizeObj.w > w0) { sizeObj.h = Math.round(w0 / ratio);
                    sizeObj.w = w0 }
            } else { if (sizeObj.h > h0) { if (keepratio) sizeObj.w = Math.round(sizeObj.w * h0 / sizeObj.h);
                    sizeObj.h = h0 } else if (inst.options.maxheight) sizeObj.h = h0; if (sizeObj.w > w0) { if (keepratio) sizeObj.h = Math.round(sizeObj.h * w0 / sizeObj.w);
                    sizeObj.w = w0 } }
            if (inst.options.resizeleftright && (inst.options.titlestyle == "left" || inst.options.titlestyle == "right") && winWidth > inst.options.sidetobottomscreenwidth) sizeObj.w +=
        ...
        inst.showData = function() { if (inst.$text.text().length > 0) inst.$elemData.show();
            inst.adjustDataHeight();
        ...
        inst.resizeLightbox = function(elemW, elemH, bAnimate, onFinish) {
            ...
            } else { if (boxW == inst.$elemWrap.width() && boxH == inst.$elemWrap.height()) speed = 0;
        ...
        inst.finishCallback = function() {
            if ((inst.options.transition == "slide" || inst.options.transition == "crossfade") && inst.existingElem >= 0)
                if (inst.options.transition == "slide") { inst.$prevelem.animate({ left: inst.direction == -1 ? "-100%" : "100%", opacity: 0 }, { duration: inst.options.transitionduration });
                    inst.$elem.animate({ left: 0, opacity: 1 }, { duration: inst.options.transitionduration, always: function() { inst.$prevelem.remove();
                            inst.$elem.removeClass("html5-elem-box-current").css({ position: "relative", height: "100%" }) } }) } else {
                    inst.$prevelem.animate({ opacity: 0 }, { duration: inst.options.transitionduration });
                    inst.$elem.animate({ opacity: 1 }, { duration: inst.options.transitionduration, always: function() { inst.$prevelem.remove();
        ...
        inst.reset =
            function() { if (inst.options.stamp) inst.$watermark.hide();
                inst.showing = false;
                inst.$image.empty();
                inst.$text.empty();
                inst.$error.hide();
                inst.$loading.hide();
                inst.$image.hide(); if (inst.options.titlestyle == "bottom" || inst.options.titlestyle == "inside") inst.$elemData.hide(); if (!inst.options.fullscreenmode) inst.$close.hide();
        ...
        inst.finish = function() {
            if (inst.options.exitanimation ==
                "fadeOut" || inst.options.exitanimation == "fadeOutDown") { inst.$lightbox.one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() { inst.$lightboxBox.removeClass("html5box-animated html5box-" + inst.options.exitanimation);
                    inst.$lightbox.removeClass("html5box-animated html5box-fadeOut");
                    inst.finishDone() });
                inst.$lightbox.addClass("html5box-animated html5box-fadeOut");
                inst.$lightboxBox.addClass("html5box-animated html5box-" + inst.options.exitanimation) } else inst.finishDone()
        };
        ...
        inst.gotoSlide = function(slide) {
            ...
            if (slide == -1) { if (inst.options.nextElem < 0) return;
                ...
                inst.options.curElem = inst.options.prevElem } else if (slide >= 0) { inst.direction = slide > inst.options.curElem ? -1 : -2;
        ...
        inst.enableSwipe = function() { var preventDefault = inst.options.isAndroid && (inst.options.swipepreventdefaultonandroid || inst.options.androidVersion >= 0 && inst.options.androidVersion <= 5) ? true : false;
        ...
        inst.embedHTML5Video = function($container, src, autoplay, loopvideo, mutevideo) {
            ...
            $("video", $container).off("ended").on("ended", function() { $(window).trigger("html5lightbox.videofinished"); if (inst.autosliding) inst.gotoSlide(-1);
                else if (inst.options.autoclose) setTimeout(function() { inst.finish() }, inst.options.autoclosedelay) })
        };
        ...
        inst.each(function() {
            ...
            if (autoopen) { var is_popped = false; if (autoopenonce) { var cookies = document.cookie ? document.cookie.split(";") : []; for (var i in cookies) { var parts = $.trim(cookies[i]).split("="); if (parts.length && parts[0] == "html5lightboxpopup") { is_popped = true; break } } } if (!is_popped) { setTimeout(function() { self.click();
                        document.cookie = autocookie }, autoopendelay); return false } }
...
var ASPlatforms = {
    ...
    applyBrowserStyles: function(object, applyToValue) { var ret = {}; for (var key in object) { ret[key] = object[key];
            ret["-webkit-" + key] = applyToValue ? "-webkit-" + object[key] : object[key];
            ret["-moz-" + key] = applyToValue ? "-moz-" + object[key] : object[key];
            ret["-ms-" + key] = applyToValue ? "-ms-" + object[key] : object[key];
            ret["-o-" + key] = applyToValue ? "-o-" + object[key] : object[key] } return ret }
};
(function($) {
    $.fn.amazingslider = function(options) {
        ...
        AmazingSlider.prototype = {
                ...
                $(".amazingslider-slides", this.container).find("li").each(function() {
                    ...
                    if (img.length > 0) {
                        ...
                        if (lightbox) instance.lightboxArray.push(elem)
                            ...
                            $(this)).length > 0) { var video = []; var $video = $("video", $(this)); var videoSrc = $video.attr("src"); var mediaType = $video.data("mediatype") ? $video.data("mediatype") : instance.checkVideoType($video.attr("src"));
                        video.push({ href: videoSrc, type: mediaType }); if (mediaType == TYPE_VIDEO_MP4)
                            if ($video.data("webm") && $video.data("webm").length > 0) video.push({ href: $video.data("webm"), type: TYPE_VIDEO_WEBM });
                        var elem = new Array(instance.elemArray.length, "", "", "", "", "", video, "", false, 0, 0, "", "", "", 0, "", mediaType, "");
                        instance.elemArray.push(elem) }
                });
                $(".amazingslider-thumbnails", this.container).find("li").each(function(index) { var img = $("img.amazingsliderthumbnailimg", $(this)); if (img.length <= 0) img = $("img", $(this)); if (img.length > 0 && instance.elemArray.length > index) { var src = img.attr("src"); var lazytags = instance.options.lazyloadtags.split(","); for (var i = 0; i < lazytags.length; i++)
                            if (img.data(lazytags[i]) && img.data(lazytags[i]).length > 0) { src = img.data(lazytags[i]); break }
                        instance.elemArray[index][ELEM_THUMBNAIL] = src } });
                if (this.options.shownumbering)
                    for (var i =
                            0; i < this.elemArray.length; i++) { var prefix = this.options.numberingformat.replace("%NUM", i + 1).replace("%TOTAL", this.elemArray.length);
            ...
            init: function(instance) {
                ...
                if ("html5lightboxshare" in params) {
                    ...
                    if (shareLink.length > 0) { if (!instance.isPaused) { instance.lightboxPaused = true;
            ...
            initHtml5Lightbox: function() {
                ...
                if (this.lightboxArray.length > 0) {
                    ...
                    var instance =
                        this;
                    this.html5Lightbox.onLightboxClosed = function() { if (instance.lightboxPaused) { instance.lightboxPaused = false;
            ...
            initSocial: function() { if (!this.options.initsocial) return;
            ...
            createSliderTimeout: function() {
                ...
                if (instance.options.pauseonmouseover) $(".amazingslider-slider-" + this.id, this.container).hover(function() { if (!instance.isPaused) { instance.sliderTimeout.pause();
                        instance.isPausedOnMouseover = true } }, function() { if (!instance.isPaused) { instance.sliderTimeout.resume(false);
                        instance.isPausedOnMouseover = false } });
            ...
            createMarkup: function() {
                ...
                if (this.options.enabletouchswipe) {
                    ...
                    touchSwipeBox.sliderTouchSwipe({
                        ...
                        swipeRight: function() { instance.container.trigger("amazingslider.touchswipe", [instance.curElem, -2]);
                            instance.videoAutoplayMode = false;
                            instance.slideRun(-2) }
                    })
                }
                $(".amazingslider-play-" + this.id, this.container).click(function() { instance.videoAutoplayMode = false;
            ...
            playVideo: function(autoplay) {
                ...
                if (autoplay && this.options.playmutedandinlinewhenautoplay && this.videoAutoplayMode) { muted = true;
                    playsinline = true }
            ...
            playMp4Video: function(href, webmhref, autoplay, muted, playsinline) {
                ...
                if (isHTML5) { var videoSrc = href; if (ASPlatforms.isFirefox() || ASPlatforms.isOpera())
                        if (webmhref) videoSrc = webmhref;
                    this.embedHTML5Video($videoWrapper, videoSrc, autoplay, muted, playsinline) } else {
                    var videoFile = href;
            ...
            playVimeoAPICallback: function() {
                ...
                if (typeof $f === "function") {
                    ...
                    vimeoPlayer.addEvent("ready",
                        function() { vimeoPlayer.addEvent("finish", function(id) { instance.videoPaused = false; if (!instance.isPaused) instance.slideRun(-1, true) });
                            vimeoPlayer.addEvent("volumechange", function(id) { instance.videoAutoplayMode = false }) })
                } else setTimeout(function() { if (instance.vimeoAPILoadCount < 10) { instance.vimeoAPILoadCount++;
                        instance.playVimeoAPICallback() } }, 300)
            },
            ...
            showTexteffect: function(event) { var sliderid = $(this).data("sliderid");
                        ...
                        if (!instance.elemArray[cur][ELEM_TITLE] && !instance.elemArray[cur][ELEM_DESCRIPTION] &&
                            ...
                            switch (effect) {
                                ...
                                case "slide":
                                    ...
                                    if (effect_dir == "left") { $textBox.css({ left: "-" + instance.textoptions.texteffectslidedistance + "px", opacity: 0 });
                                        $textBox.delay(instance.textoptions.texteffectdelay).animate({ left: "0px", opacity: 1 }, instance.textoptions.texteffectduration, instance.textoptions.texteffecteasing) } else if (effect_dir == "right") {
                                        $textBox.css({
                                    ...
                                    } else if (effect_dir == "top") { $textBox.css({ top: "-" + instance.textoptions.texteffectslidedistance + "px", opacity: 0 });
                                        $textBox.delay(instance.textoptions.texteffectdelay).animate({ top: "0px", opacity: 1 }, instance.textoptions.texteffectduration, instance.textoptions.texteffecteasing) } else if (effect_dir == "bottom") {
                                        $textBox.css({
                            ...
                            if (instance.textoptions.texteffectseparate && instance.elemArray[cur][ELEM_DESCRIPTION].length > 0) {
                                ...
                                switch (effect1) {
                                    ...
                                    case "slide":
                                        ...
                                        } else if (effect_dir1 == "right") { $textBox1.css({ left: instance.textoptions.texteffectslidedistance1 + "px", opacity: 0 });
                                            $textBox1.delay(instance.textoptions.texteffectdelay1).animate({ left: "0px", opacity: 1 }, instance.textoptions.texteffectduration1, instance.textoptions.texteffecteasing1) } else if (effect_dir1 ==
                                            "top") { $textBox1.css({ top: "-" + instance.textoptions.texteffectslidedistance1 + "px", opacity: 0 });
                                            $textBox1.delay(instance.textoptions.texteffectdelay1).animate({ top: "0px", opacity: 1 }, instance.textoptions.texteffectduration1, instance.textoptions.texteffecteasing1) } else if (effect_dir1 == "bottom") { $textBox1.css({ top: instance.textoptions.texteffectslidedistance1 + "px", opacity: 0 });
                            ...
                            if (instance.textoptions.texteffectseparate && instance.elemArray[cur][ELEM_BUTTON].length > 0) {
                                ...
                                switch (effect2) {
                                    ...
                                    case "slide":
                                        ...
                                        if (effect_dir2 == "left") { $textBox2.css({ left: "-" + instance.textoptions.texteffectslidedistance2 + "px", opacity: 0 });
                                            $textBox2.delay(instance.textoptions.texteffectdelay2).animate({ left: "0px", opacity: 1 }, instance.textoptions.texteffectduration2, instance.textoptions.texteffecteasing2) } else if (effect_dir2 == "right") {
                                            $textBox2.css({
                                        ...
                                        } else if (effect_dir2 == "top") { $textBox2.css({ top: "-" + instance.textoptions.texteffectslidedistance2 + "px", opacity: 0 });
                                            $textBox2.delay(instance.textoptions.texteffectdelay2).animate({ top: "0px", opacity: 1 }, instance.textoptions.texteffectduration2, instance.textoptions.texteffecteasing2) } else if (effect_dir2 == "bottom") {
                                            $textBox2.css({
            ...
            resizeFullscreenImage: function($imgElem) {
                ...
                if (sliderRatio < imgRatio)
                    if (this.options.scalemode == "fit") { this.curImageMaxWidth = sliderRatio / imgRatio * 100;
                        this.curImageMarginLeft = 50 - this.curImageMaxWidth / 2 } else this.curImageMarginTop = -1 * (imgRatio -
                        sliderRatio) * 50;
                else if (this.options.scalemode == "fit") this.curImageMarginTop = (sliderRatio - imgRatio) * 50;
                else { this.curImageMarginLeft = (1 / sliderRatio - 1 / imgRatio) * sliderRatio * 50;
                ...
                if (this.options.navthumbnavigationstyle != "auto") {
                    ...
                    if (this.options.navstyle == "thumbnails" && this.options.navthumbresponsive) {
                        ...
                        if (this.options.navdirection ==
                            "vertical") { $carLeftArrow.css({ top: this.options.navthumbnavigationstyle == "arrowoutside" ? "-" + this.options.navthumbnavigationarrowimageheight + "px" : "0px", left: "0px", "margin-left": p + "px" });
                            $carRightArrow.css({ bottom: this.options.navthumbnavigationstyle == "arrowoutside" ? "-" + this.options.navthumbnavigationarrowimageheight + "px" : "0px", left: "0px", "margin-left": p + "px" }) } else {
                            $carLeftArrow.css({
            ...
            createStyle: function() {
                ...
                if (!this.options.isresponsive) {
                    ...
                    this.container.css({ "width": this.options.width, "height": this.options.navdirection == "horizontal" && this.options.navmultirows ? "auto" : this.options.height })
                } else { this.resizeSlider(); var instance = this;
                ...
                if (this.options.showshadow) { var b = "0px 0px " + this.options.shadowsize + "px " + this.options.shadowcolor;
                    styleCss += "box-shadow:" + b + ";-moz-box-shadow:" + b + ";-webkit-box-shadow:" + b + ";"; if (ASPlatforms.isIE678() || ASPlatforms.isIE9) styleCss += "filter:progid:DXImageTransform.Microsoft.Shadow(color=" + this.options.shadowcolor + ",direction=135,strength=" + this.options.shadowsize + ");" }
                styleCss += "}";
            ...
            createArrows: function() {
                ...
                $leftArrow.click(function() { instance.container.trigger("amazingslider.arrow", [instance.curElem, -2]);
                    instance.videoAutoplayMode = false;
                    instance.slideRun(-2) });
                ...
                $rightArrow.click(function() { instance.container.trigger("amazingslider.arrow", [instance.curElem, -1]);
                    instance.videoAutoplayMode = false;
                    instance.slideRun(-1) });
                if (this.options.arrowstyle == "always") { $leftArrow.css({ display: "block" });
                    ...
                    $(".amazingslider-wrapper-" +
                        this.id, this.container).hover(function() { clearTimeout(instance.arrowTimeout); if (ASPlatforms.isIE678()) { $(".amazingslider-arrow-left-" + instance.id, instance.container).show();
                            $(".amazingslider-arrow-right-" + instance.id, instance.container).show() } else { $(".amazingslider-arrow-left-" + instance.id, instance.container).fadeIn();
                            $(".amazingslider-arrow-right-" + instance.id, instance.container).fadeIn() } }, function() {
                        instance.arrowTimeout = setTimeout(function() {
                            if (ASPlatforms.isIE678()) {
                                $(".amazingslider-arrow-left-" +
                                    instance.id, instance.container).hide();
                                $(".amazingslider-arrow-right-" + instance.id, instance.container).hide()
                            } else { $(".amazingslider-arrow-left-" + instance.id, instance.container).fadeOut();
            ...
            updateCarouselLeftRightArrow: function(l) {
                ...
                if (this.options.navdirection ==
                    ...
                    if (l == 0) { $(".amazingslider-car-left-arrow-" + this.id, this.container).css({ "background-position": "left bottom", cursor: "" });
                        $(".amazingslider-car-left-arrow-" + this.id, this.container).data("disabled", true) } else { $(".amazingslider-car-left-arrow-" + this.id, this.container).css({ "background-position": "left top", cursor: "pointer" });
                        $(".amazingslider-car-left-arrow-" + this.id, this.container).data("disabled", false) }
                    if (l == $navContainer.height() - $bulletWrapper.height()) {
                        $(".amazingslider-car-right-arrow-" +
                            this.id, this.container).css({ "background-position": "right bottom", cursor: "" });
                        $(".amazingslider-car-right-arrow-" + this.id, this.container).data("disabled", true)
                    } else { $(".amazingslider-car-right-arrow-" + this.id, this.container).css({ "background-position": "right top", cursor: "pointer" });
            ...
            calcNavThumbSize: function() {
                ...
                if (winW < this.options.navthumbsmallsize) {
                    ...
                    } else { this.options.navwidth = this.options.navthumbsmallwidth;
                    ...
                    if (this.options.navthumbresponsivemode == "samecolumn" && this.options.navdirection ==
                        "horizontal") { this.options.navwidth = (this.options.width - this.options.navspacing * (this.options.navthumbmediumcolumn - 1)) / this.options.navthumbmediumcolumn;
                        this.options.navheight = this.options.navwidth * this.options.navoriginalheight / this.options.navoriginalwidth;
                        this.options.navthumbcolumn = this.options.navthumbmediumcolumn } else { this.options.navwidth = this.options.navthumbmediumwidth;
                    ...
                    if (this.options.navthumbresponsivemode == "samecolumn" && this.options.navdirection == "horizontal") { this.options.navwidth = (this.options.width - this.options.navspacing * (this.options.navthumboriginalcolumn - 1)) / this.options.navthumboriginalcolumn;
                        this.options.navheight = this.options.navwidth * this.options.navoriginalheight / this.options.navoriginalwidth;
                        this.options.navthumbcolumn = this.options.navthumboriginalcolumn } else {
            ...
            createNav: function() {
                ...
                if (this.options.navstyle != "none") {
                    ...
                    if (instance.options.navmultirows && instance.options.navdirection == "horizontal" && instance.options.navthumbresponsivemode == "samecolumn") { var $bullets = $(".amazingslider-bullet-" + instance.id, instance.container); for (var i = 1; i < $bullets.length; i++)
                    ...
                    if (instance.options.navthumbnavigationstyle == "auto") $nav.mousemove(function(e) {
                        if (instance.options.navdirection ==
                            "vertical") { if ($nav.height() >= $bulletWrapper.height()) return; var d = e.pageY - $nav.offset().top; if (d < 10) d = 0; if (d > $nav.height() - 10) d = $nav.height(); var r = d / $nav.height(); var l = ($nav.height() - $bulletWrapper.height()) * r;
                            $bulletWrapper.animate({ "margin-top": l }, { queue: false, duration: 20, easing: "easeOutCubic" }) } else {
                        ...
                        var m = 0;
                        if (instance.options.navmultirows && instance.options.navdirection == "horizontal") { var n = Math.floor($nav.width() / (instance.options.navwidth + instance.options.navspacing)); if (n <= 0) n = 1;
                            m = Math.floor(($nav.width() - n * instance.options.navwidth - (n - 1) * instance.options.navspacing) / 2); if (instance.options.navthumbresponsivemode == "samecolumn") m = 0;
                            $navContainer.css({ width: "100%", "margin-left": m + "px" }) } else if (instance.options.navthumbnavigationstyle ==
                            "arrow") { m = instance.options.navthumbnavigationarrowimagewidth + instance.options.navspacing; if (instance.options.navdirection == "horizontal") { var n = Math.floor(($nav.width() - 2 * m + instance.options.navspacing) / (instance.options.navwidth + instance.options.navspacing)); if (n <= 0) n = 1;
                                m = Math.floor(($nav.width() - n * instance.options.navwidth - (n - 1) * instance.options.navspacing) / 2);
                                $navContainer.css({ "margin-left": m + "px", "margin-right": m + "px" }) } else $navContainer.css({ "margin-top": m + "px", "margin-bottom": m + "px" }) } else if (instance.options.navdirection ==
                        ...
                        $carRightArrow.click(function() { if (instance.options.navdirection == "vertical") instance.carMoveTop();
                            else instance.carMoveLeft() });
                        if (instance.options.navdirection == "vertical" && $bulletWrapper.height() > $navContainer.height() ||
                            instance.options.navdirection == "horizontal" && $bulletWrapper.width() > $navContainer.width()) { $carLeftArrow.css({ display: "block", "background-position": "left bottom", cursor: "" });
                        ...
                        if (instance.options.navthumbnavigationstyle == "arrowinside") {
                            ...
                            $nav.hover(function() {
                                if (instance.options.navdirection == "vertical" && $bulletWrapper.height() > $navContainer.height() || instance.options.navdirection == "horizontal" &&
                                    $bulletWrapper.width() > $navContainer.width()) { $carLeftArrow.fadeIn();
                    ...
                    this.container.on("amazingslider.switch",
                        function(event, prev, cur) { $("#amazingslider-bullet-" + instance.id + "-" + prev, instance.container)["bulletNormal" + instance.id]();
                    ...
                    if (this.options.navshowpreview) {
                        ...
                        if (this.options.navshowplayvideo) { var $previewPlay = $("<div class='amazingslider-nav-preview-play-" + this.id + "' style='display:none;position:absolute;left:0;top:0;width:100%;height:100%;" + 'background:url("' + this.options.navplayvideoimage + '") no-repeat center center;' + "' ></div>");
                ...
                if (this.options.navshowbuttons) {
                    ...
                    if (this.options.navshowarrow) {
                        ...
                        $navLeft.click(function() { instance.videoAutoplayMode = false;
                            instance.slideRun(-2) });
                    ...
                    if (this.options.navshowplaypause) {
                        ...
                        if (this.options.navshowplaypausestandalone && this.options.navshowplaypausestandaloneautohide) {
                            ...
                            this.$wrapper.hover(function() { if (instance.isPaused) { $navPlay.fadeIn();
                                    ...
                                    $navPause.fadeIn() } }, function() { $navPlay.fadeOut();
                                $navPause.fadeOut() })
            ...
            createNavBullet: function(index) {
                ...
                $bullet.hover(function() {
                    ...
                    function() { if ($(this).data("index") != instance.curElem) $(this)["bulletNormal" + instance.id](); if (instance.options.navshowpreview) { var $preview = $(".amazingslider-nav-preview-" + instance.id, instance.container);
                            $preview.delay(500).fadeOut() } });
                $bullet.click(function() { instance.videoAutoplayMode = false;
                ...
                if (this.options.navstyle == "bullets") {
                    ...
                    $.fn["bulletNormal" + this.id] = function() { $(this).css({ opacity: instance.options.navopacity, filter: "alpha(opacity=" + Math.round(100 * instance.options.navopacity) + ")" });
                        $(this).removeClass("amazingslider-bullet-selected").removeClass("amazingslider-bullet-highlighted"); if (instance.options.navbordercolor) $(this).css({ "background-color": instance.options.navbordercolor }) };
                    $.fn["bulletHighlight" + this.id] = function() { $(this).css({ opacity: 1, filter: "alpha(opacity=100)" }); if (instance.options.navborderhighlightcolor) $(this).css({ "background-color": instance.options.navborderhighlightcolor });
            ...
            showImage: function(slideDirection, transEffect) {
                ...
                $(imgLoader).on("load", function() {
                    ...
                    instance.curImageMarginLeft = 0;
                    instance.curImageMaxWidth = 100;
                    if (instance.options.scalemode == "flexheight") { instance.options.flexratio = imgRatio;
                        ...
                        instance.container.css({ "height": instance.options.navdirection == "horizontal" && instance.options.navmultirows ? "auto" : instance.options.height }) } else if (sliderRatio <
                        imgRatio)
                    ...
                    else { instance.curImageMarginLeft = (1 / sliderRatio - 1 / imgRatio) * sliderRatio * 50;
                    ...
                    }, function() { instance.isAnimating = false; if (!instance.isPausedOnMouseover) instance.sliderTimeout.resume(true);
                        else instance.sliderTimeout.unsetstartandpause() }, function(timeoutid) { instance.transitionTimeout = timeoutid; if (!instance.isPaused && !instance.videoPaused && instance.elemArray.length > 1) instance.sliderTimeout.startandpause() });
            ...
            calcIndex: function(index) {
                var r;
                if (index == -2) { this.nextElem = this.curElem;
                    this.curElem = this.prevElem;
                    this.prevElem = this.curElem - 1 < 0 ? this.elemArray.length - 1 : this.curElem - 1 } else if (index == -1) {
                    this.prevElem = this.curElem;
                    this.curElem = this.nextElem;
                    this.nextElem = this.curElem + 1 >= this.elemArray.length ? 0 :
                        this.curElem + 1
                } else if (index >= 0) { this.curElem = index;
        ...
        this.each(function() {
            ...
            for (var key in this.options)
                if (key.substring(0, 17) == "customtransition_") { var matches = key.split("_"); if (matches.length == 3)
...
(function($) {
    $.fn.amazingsliderTransition = function(id, $prev, $next, transition, callback, transitionStartCallback) {
        ...
        if (effect == "fade") { transitionStartCallback();
        ...
        } else if (effect == "fadeoutfadein") { transitionStartCallback();
            $parent.css({ overflow: "hidden" });
            $next.fadeIn(duration, easing); if ($prev && $prev.length) $prev.fadeOut(duration, easing, function() { $prev.remove();
                callback() });
            else callback() } else if (effect == "kenburns") {
            $parent.css({ overflow: "hidden" });
            ...
            if (direction) {
                ...
                setTimeout(function() {
                    ...
                    setTimeout(function() { $prev.remove();
                        callback() }, duration + 500)
                }, 50)
            } else { $next.css({ left: "-100%" });
                $prev.css({ transition: "left " + duration + "ms " + easing });
                $next.css({ transition: "left " + duration + "ms " + easing });
                setTimeout(function() { $next.css({ left: "0%" }); if ($prev && $prev.length) $prev.css({ left: "100%" });
                    setTimeout(function() { $prev.remove();
                        callback() }, duration + 500) }, 50) }
            ...
            if (direction) { $next.css({ left: "100%" });
                $next.animate({ left: "0%" }, duration, easing); if ($prev && $prev.length) $prev.animate({ left: "-100%" }, duration, easing, function() { $prev.remove();
                    callback() });
                else callback() } else { $next.css({ left: "-100%" });
                $next.animate({ left: "0%" }, duration, easing); if ($prev && $prev.length) $prev.animate({ left: "100%" }, duration, easing, function() { $prev.remove();
                    callback() });
                else callback() }
        ...
        } else if (effect == "blinds") { $parent.css({ overflow: "hidden" });
            $parent.blindsTransition(id, $prev, $next, $.extend({ duration: duration, easing: easing, direction: direction, imgmargintop: transition.imgmargintop, imgmarginleft: transition.imgmarginleft, imgmaxwidth: transition.imgmaxwidth }, transition["blinds"]), callback, transitionStartCallback) } else if (effect == "threed" || effect ==
        ...
        } else if (effect == "shuffle") { $parent.css({ overflow: "visible" });
            $parent.shuffleTransition(id, $prev, $next, $.extend({ duration: duration, easing: easing, direction: direction, imgmargintop: transition.imgmargintop, imgmarginleft: transition.imgmarginleft, imgmaxwidth: transition.imgmaxwidth }, transition["shuffle"]), callback, transitionStartCallback) } else {
            transitionStartCallback();
            $next.show();
            $prev.remove();
            callback()
    ...
    $.fn.kenburnsTransition = function(id, $prev, $next, options, callback, transitionStartCallback) {
        var $parent = this;
        $parent.off("transitionFinished").on("transitionFinished", function() { $parent.off("transitionFinished");
            $prev.remove();
            callback() });
        $next.hide();
        $prev.insertBefore($next);
        ...
        if (ASPlatforms.isIE6789()) {
            ...
            switch (direction) {
                case 0:
                    directioncss = { top: 0, left: "auto", bottom: "auto", right: 0 }; break;
                case 1:
                    directioncss = { top: "auto", left: 0, bottom: 0, right: "auto" }; break;
                case 2:
                    directioncss = { top: "auto", left: "auto", bottom: 0, right: 0 }; break;
                default:
            ...
            } else { $next.css({ width: "100%", height: "100%", display: "block", opacity: 0 });
    ...
    $.fn.sliceTransition = function(id, $prev, $next, options, callback, transitionStartCallback) {
        ...
        for (i = 0; i < options.slicecount; i++) {
            ...
            if (Math.abs(options.imgmarginleft) > 0) { $img.css({ "margin-left": options.slicecount * options.imgmarginleft + "%" });
                $img.css({ "max-width": options.slicecount * options.imgmaxwidth + "%", left: "-" + sliceW * i + "px", width: options.slicecount * options.imgmaxwidth + "%" }) } else { $img.css({ "margin-top": options.slicecount * options.imgmargintop + "%" });
        ...
        var interval = options.duration / 2 /
            options.slicecount;
        index = 0;
        slices.each(function() { var slice = $(this); switch (effect) {
                case "up":
    ...
    $.fn.blindsTransition = function(id, $prev, $next, options, callback, transitionStartCallback) {
        ...
        slices.each(function() {
            var slice =
                $(this);
            var target;
            if (!options.direction) { slice.css({ left: "", right: "-100%" });
    ...
    $.fn.threedTransition = function(id, $prev, $next, options, callback, transitionStartCallback) {
        ...
        for (i = 0; i < options.slicecount; i++) {
            ...
            if (Math.abs(options.imgmarginleft) > 0) { $nextImg.css({ "margin-left": options.slicecount * options.imgmarginleft + "%" });
                $nextImg.css({ "max-width": options.slicecount * options.imgmaxwidth + "%", left: "-" + sliceW * i + "px", width: options.slicecount * options.imgmaxwidth + "%" }) } else { $nextImg.css({ "margin-top": options.slicecount * options.imgmargintop + "%" });
    ...
    $.fn.threedHorizontalTransition = function(id, $prev, $next, options, callback, transitionStartCallback) {
        ...
        for (i = 0; i < options.slicecount; i++) {
            ...
            if (Math.abs(options.imgmarginleft) > 0) { $nextImg.css({ "margin-left": options.imgmarginleft + "%", height: "auto" });
                $nextImg.css({ "max-width": options.imgmaxwidth + "%", top: "-" + sliceH * i + "px", width: options.imgmaxwidth + "%" }) } else {
                $nextImg.css({
            ...
            } else { $curImg.css({ "margin-top": options.previmgmargintop + "%" });
        ...
        $parent.off("transitionFinished").on("transitionFinished",
            function() { $parent.off("transitionFinished");
                $prev.remove();
                $next.show();
                setTimeout(function() { $cubeWrapper.remove() }, 100);
                callback() });
    ...
    $.fn.threedFlipTransition = function(id, $prev, $next, options, callback, transitionStartCallback) {
        ...
        for (i = 0; i < options.slicecount; i++) {
            ...
            if (Math.abs(options.previmgmarginleft) > 0) { $curImg.css({ "margin-left": options.slicecount * options.previmgmarginleft + "%" });
                $curImg.css({ "max-width": options.slicecount * options.previmgmaxwidth + "%", left: "-" + sliceW * i + "px", width: options.slicecount * options.previmgmaxwidth + "%" }) } else { $curImg.css({ "margin-top": options.slicecount * options.previmgmargintop + "%" });
                $curImg.css({ "max-width": options.slicecount * 100 + "%", left: "-" + sliceW * i + "px", width: options.slicecount * 100 + "%" }) }
            var $curImgSlice =
